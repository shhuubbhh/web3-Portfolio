    ...
    <section id="home" className="min-h-screen flex flex-col justify-center items-start relative pt-24 pb-16 px-6 md:px-16 lg:px-24 overflow-hidden">
      ...
      <div className="max-w-6xl w-full text-left z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col items-start">
          ...
          <div className="relative mb-6 select-none ml-8 md:ml-12">
            {/* Radar waves expanding behind profile */}
            <div className="absolute inset-0 rounded-2xl border border-brand-purple/10 scale-[1.45] animate-ping opacity-30" style={{ animationDuration: '3.5s' }} />
            <div className="absolute inset-0 rounded-2xl border border-brand-blue/5 scale-[1.7] animate-ping opacity-15" style={{ animationDuration: '5s' }} />

            {/* Floating Web3 Badge: Top-Left */}
            <motion.div
              animate={{ y: [0, -4, 0] }}
              transition={{ duration: 3.5, repeat: Infinity, ease: 'easeInOut' }}
              className="absolute top-[-15px] left-[-30px] md:left-[-40px] bg-[#121216]/90 border border-white/5 px-3 py-1.5 rounded-lg text-[10px] md:text-xs font-mono text-gray-400 backdrop-blur-sm shadow-md flex items-center gap-1.5 z-30"
            >
            ...
            <motion.div
              ...
              className="absolute top-[-5px] right-[-30px] md:right-[-40px] bg-[#121216]/90 border border-white/5 px-3 py-1.5 rounded-lg text-[10px] md:text-xs font-mono text-gray-400 backdrop-blur-sm shadow-md flex items-center gap-1.5 z-30"
            >
              <span className="w-1.5 h-1.5 rounded-full bg-brand-success animate-pulse" />
            ...
            <motion.div
              ...
              className="absolute bottom-[5px] left-[-30px] md:left-[-40px] bg-[#121216]/90 border border-white/5 px-3 py-1.5 rounded-lg text-[10px] md:text-xs font-mono text-gray-400 backdrop-blur-sm shadow-md flex items-center gap-1.5 z-30"
            >
            ...
            <motion.div
              ...
              className="absolute bottom-[-5px] right-[-25px] md:right-[-35px] bg-[#121216]/90 border border-white/5 px-3 py-1.5 rounded-lg text-[10px] md:text-xs font-mono text-gray-400 backdrop-blur-sm shadow-md flex items-center gap-1.5 z-30"
            >
            ...
            >
              ...
              <img
                src="/avatar.jpg"
                alt="Shubh Avatar"
                className="absolute inset-[4px] rounded-2xl w-[calc(100%-8px)] h-[calc(100%-8px)] object-cover z-20"
              />
            </motion.div>
          </div>
