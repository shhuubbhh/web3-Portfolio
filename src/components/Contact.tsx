...
export const Contact: React.FC = () => {
  const socials = [
    ...
    { 
      ...
      handle: 'subhash-rajpurohit', 
      color: 'hover:text-[#0A66C2] hover:border-[#0A66C2]/30' 
    },
    { name: 'Discord', icon: <MessageSquare size={18} />, url: 'https://discord.com', handle: 'subhash#1234', color: 'hover:text-[#5865F2] hover:border-[#5865F2]/30' },
    { name: 'Telegram', icon: <Send size={18} />, url: 'https://t.me', handle: 'subhash_raj', color: 'hover:text-[#0088cc] hover:border-[#0088cc]/30' },
    { name: 'Email', icon: <Mail size={18} />, url: 'mailto:subhash@example.com', handle: 'subhash@example.com', color: 'hover:text-brand-purple hover:border-brand-purple/30' },
  ];
